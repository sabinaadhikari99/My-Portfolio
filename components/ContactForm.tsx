...
const field =
  "w-full rounded-xl border border-border bg-background px-4 py-3 text-base text-foreground placeholder:text-subtle transition-colors duration-300 focus:border-accent focus:outline-none";
    ...
    >
      ...
      <div className="mt-6 flex flex-wrap items-center gap-4">
        <button
          ...
          className="group inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-accent-foreground transition-colors duration-300 hover:bg-accent-hover disabled:cursor-not-allowed disabled:opacity-60"
        >
