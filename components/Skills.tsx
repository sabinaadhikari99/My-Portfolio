          ...
          >
            ...
            <ul className="mt-5 flex flex-wrap gap-2">
              {group.items.map((item) => (
                <li
                  key={item}
                  className="rounded-full border border-border bg-background px-3.5 py-1.5 text-sm text-foreground-muted transition-colors duration-300 hover:border-primary hover:text-primary"
                >
                  {item}
                </li>
              ))}
